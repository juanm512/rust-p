...
(self.calcular_perimetro()*0.5 * (self.calcular_perimetro()*0.5 - self.lado_1) * (self.calcular_perimetro()*0.5 - self.lado_2) * (self.calcular_perimetro()*0.5 - self.lado_3) ).sqrt()
}
