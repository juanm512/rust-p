...
// guardando, leyendo o modificando archivos.No debe modificar los tests hechos en el punto a.
// Si puede agregar más en caso de que haga métodos nuevos para cumplir con este
...
mod tests {
    ...
    fn create_test_data() -> StreamingRust {
        ...
        plataforma.crear_usuario_con_suscripcion(
            7,
            "Roberto Agnisis".to_string(),
            "rob.ag@example.com".to_string(),
            MediosDePago::TransferenciaBancaria(TransferenciaBancariaData {
                bank_name: "Galicia".to_string(),
                account_number: "165".to_string(),
                routing_number: "873".to_string(),
            }),
            TipoSuscripcion::Clasic,
            300.0,
            1,
        ...
        plataforma.crear_usuario_con_suscripcion(
            8,
            "Tomas Menende".to_string(),
            "t.men@example.com".to_string(),
            MediosDePago::Cripto(CriptoData {
                wallet_address: "0xv82y3bbdvf89y2b5n3u9sfvyb8d".to_string(),
                transaction_hash: "0x52yvf23u7832f6vr32v68r32v78563".to_string(),
            }),
            TipoSuscripcion::Basic,
            300.0,
            1,
    ...
    fn test_upgrade_suscripcion() {
        ...
        assert_eq!(suscripcion.tipo, TipoSuscripcion::Super);
    ...
    fn test_downgrade_suscripcion() {
        let mut plataforma = create_test_data();
        plataforma.downgrade_suscripcion(1);
        ...
        plataforma.downgrade_suscripcion(3);

        let suscripcion = plataforma
            .suscripciones
            .iter()
            .find(|s| s.id_usuario == 3)
            .unwrap();
